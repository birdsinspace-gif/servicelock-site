    ...
    <div className="container relative max-w-6xl">
      <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div>
          <motion.div
            {...anim()}
            className="inline-flex items-center rounded-full border border-border bg-card px-4 py-2 text-xs text-muted-foreground"
          >
...
const LosingMoney = () => (
  <section className="py-20 text-center">
    <div className="container max-w-5xl">
      ...
      <motion.div
        {...anim(0.25)}
        className="mt-10 mx-auto max-w-3xl rounded-3xl border border-border bg-card p-8"
      >
          ...
          <div>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={item}
                  className="flex items-start gap-3 rounded-2xl border border-border bg-background px-4 py-4 text-sm"
                >
...
const FinalCTA = () => (
  <section className="py-20">
    <div className="container max-w-5xl">
      <motion.div
        {...anim()}
        className="rounded-[36px] border border-border bg-card px-8 py-10 text-center md:px-12 md:py-14"
      >
        <p className="text-xs uppercase tracking-[0.22em] text-muted-foreground">
          Final step
        </p>
